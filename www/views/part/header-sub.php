	...
	<div id="snb">
		...
		<ul class="depth2">
			...
			<?php } else if(getDepthId($pagePath, 0) == "stats"){ ?>
				...
				<li<?php if(getDepthId($pagePath, 1) == "6"){ ?> class="on"<?php } ?>><a href="stats-8.php">최근수록자료</a></li>
				<li<?php if(getDepthId($pagePath, 1) == "7"){ ?> class="on"<?php } ?>><a href="stats-9.php">부서별통계구조</a></li>
			<?php } else if(getDepthId($pagePath, 0) == "indicator"){ ?>
			...
			<h3 class="title">
				<strong>
					...
					<?php } else if(getDepthId($pagePath, 0) == "stats"){ ?>
						...
						<?php } else if(getDepthId($pagePath, 1) == "7"){ ?>
							최근수록자료
						<?php } else if(getDepthId($pagePath, 1) == "9"){ ?>
							부서별통계구조
						<?php } ?>
